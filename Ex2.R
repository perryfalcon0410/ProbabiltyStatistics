...
library(car)
#Import data
data <- read.csv(file = 'Video_Games_Sales.csv', sep = ",",header = T, nrows = 100)
...
data <- read.csv('/Users/ZEPHYRUS/Downloads/archive/Video_Games_Sales.csv', sep = ",", header = T)
